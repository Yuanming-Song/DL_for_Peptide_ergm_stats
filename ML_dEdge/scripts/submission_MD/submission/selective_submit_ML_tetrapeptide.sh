...
while IFS= read -r line; do
    ...
    TARGET_DIR="${MARTINI_DIR}/Tetrapeptide_dis_C${c_pos}"
    ...
    if [ "$DEBUG" = true ]; then
        ...
        sbatch --job-name="${pos1}_${pos2}_${pos3}_${pos4}" \
            ...
            --wrap="bash ${SCRIPT_DIR}/Cys_stapled_tetrapeptide_MARTINI_run.sh ${pos1} ${pos2} ${pos3} ${pos4}"
    fi
done < "$SEQUENCES_FILE" 
#echo ${SCRIPT_DIR}/Cys_stapled_tetrapeptide_MARTINI_run.sh