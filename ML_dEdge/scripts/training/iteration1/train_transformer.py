...
def main():
    ...
    if args.task_type == 'Classification':
        ...
        df_test_save.to_csv('Sequential_Peptides_edges/Test_cla_{}_Acc_{}_lr_{}_bs_{}.csv'.format(args.model,test_acc,args.lr,args.batch_size))
    ...
    if args.task_type == 'Regression':
        ...
        df_test_seq = pd.read_csv('Sequential_Peptides_edges/ddedge_test_seqs.csv')
        df_test_save['feature'] = df_test_seq['Feature']
        df_test_save['predict'] = predict
        df_test_save['label'] = labels
        error = []
        ...
        df_test_save['R2'] = R2
        df_test_save.to_csv('Sequential_Peptides_edges/Test_reg_{}_MAE_{}_lr_{}_bs_{}.csv'.format(args.model,MAE,args.lr,args.batch_size))

    #delete model for some reason?
